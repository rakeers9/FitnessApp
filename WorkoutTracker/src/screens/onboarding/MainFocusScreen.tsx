...
interface MainFocusScreenProps {
  navigation?: any;
...
const MainFocusScreen: React.FC<MainFocusScreenProps> = ({
  navigation,
  ...
  // Animation refs
  const progressAnim = useRef(new Animated.Value(0.388)).current;
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          {/* Question */}
          <Text style={styles.title}>What is your main focus now?</Text>
      ...
      <View style={styles.continueContainer}>
        <TouchableOpacity
          style={[
            ...
            !selectedFocus && styles.continueButtonDisabled,
          ]}
          onPress={handleContinue}
          activeOpacity={selectedFocus ? 0.9 : 1}
          disabled={!selectedFocus}
        >
          <Text
            style={[
              styles.continueButtonText,
              !selectedFocus && styles.continueButtonTextDisabled,
            ]}
          >
            Continue
          </Text>
...
export default MainFocusScreen;