...
const ChallengeScreen: React.FC<ChallengeScreenProps> = ({
  ...
  // Animation refs
  const progressAnim = useRef(new Animated.Value(0.222)).current;
  ...
  const handleContinue = () => {
    if (selectedChallenge && onContinue) {
      ...
      <View style={styles.continueContainer}>
        <TouchableOpacity
          style={[
            ...
            !selectedChallenge && styles.continueButtonDisabled,
          ]}
          onPress={handleContinue}
          activeOpacity={selectedChallenge ? 0.9 : 1}
          disabled={!selectedChallenge}
        >
          <Text
            style={[
              styles.continueButtonText,
              !selectedChallenge && styles.continueButtonTextDisabled,
            ]}
          >
            Continue
          </Text>
